...
export const fallbackMissions: Mission[] = [
  {
    ...
    scenario: 'Evaluate conduction, convection, and radiation effects before selecting material.',
    choices: [
  ...
  },
  {
    ...
    choices: ['Half as much', 'The same', 'Twice as much', 'Cannot be compared'],
    answerIndex: 2,
  ...
  },
  {
    ...
    prompt: 'Why do major ocean convection currents form predictable global loops?',
    ...
    answerIndex: 1,
    explanation: 'Uneven thermal input and salinity differences create density-driven flow patterns.',
    xp: 110,
  },
  {
    id: 'earth-lab-002',
    ...
    prompt: 'Radar shows a cold front moving into warm humid air. What local weather is most probable next?',
  ...
  },
  {
    ...
    prompt: 'A city can choose one long-term energy plan. Which option is most sustainable?',
    ...
    answerIndex: 1,
    explanation: 'A diversified renewable strategy improves long-term sustainability and resilience.',
    xp: 120,
  },
  {
    ...
    prompt: 'Which action most directly reduces human pressure on local watershed and habitat systems?',
